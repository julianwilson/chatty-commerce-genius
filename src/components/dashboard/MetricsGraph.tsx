...
<lov-code>
Let's update the MetricsGraph component to add the "Avg. Markdown %" metric. We'll modify the mock data generation and add a new line to the graph:

<lov-write file_path="src/components/dashboard/MetricsGraph.tsx">
import React from 'react';
import {
  LineChart,
  Line,
...
const metrics = [
  ...
  { id: 'aov', name: 'AOV', value: '$89.12', change: '+32%' },
  { id: 'unitsPerTransaction', name: 'UPT', value: '2.5', change: '+25%' },
  { id: 'avgMarkdown', name: 'Avg. Markdown %', value: '15.2%', change: '-10%' }
];
